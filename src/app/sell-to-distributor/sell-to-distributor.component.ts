...
@Component({
  selector: 'app-sell-to-distributor',
  templateUrl: './sell-to-distributor.component.html',
  styleUrls: ['./sell-to-distributor.component.css']
})
export class SellToDistributorComponent implements OnInit {
  accounts: string[];
  _add: any;
